      ...
      <div className="overlayContent">
        ...
        <div className="bottomOfScreenComponents">
          <div className="distanceTrackers">
            ...
            <DistanceTracker teamId="1446e8a4-350c-4aa1-a997-c05fb87ef102" color={"#8fdeb0"} teamName={"Hugh \n& Alex"}/>
            <DistanceTracker teamId="79cd421b-81d4-4b00-8b59-da9e7560dc4b" color={"#96d2ec"} teamName={"Jaz \n& Will"}/>
          </div>
