...
function RulesPage() {
  ...
  return (
    ...
    <TabPanel>
       <ul>
        <h2>General</h2>
        <li>Teams start with €50 in the bank (unless the game begins in Paris, in which case teams start with €80)</li>
        <li>In order to progress, pairs must ‘claim’ routes on the game map. To do this, teams need to ensure they have completed at least one challenge card, or have decided to ‘skip’ the city</li>
        <li>Each team must take a rest period of 10hrs every night, starting between 20:00 and 00:00</li>
        <li>Bonus Sites give extra 100km</li>
        <li>The players must travel between cities via train, and cannot use buses, coaches, taxis or planes to make intercity connections</li>
        <li>When a team arrives into a new city on the map, they must take a selfie at the station, post an update into the ACTG WhatsApp chat and claim the route on the ACTG app within 5 minutes of arriving in the city.</li>


        <h2>Challenge Cards</h2>
        <li>You need to complete at least one card before moving on a route you are claiming.</li>
        <li>You cannot leave a city with a challenge card drawn but not completed or vetoed</li>
        ...
        <li>Some challenges appear more than once in the deck. Some challenge cards must be completed in full by one member of the team, some must be completed in full by both members of the team, and some may be done by either one or both members of the team.</li>
